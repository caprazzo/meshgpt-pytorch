...
class MeshAutoencoderTrainer(Module):
    ...
    def next_data_to_forward_kwargs(self, dl_iter) -> dict:
        ...
        maybe_del(forward_kwargs, 'texts', 'text_embeds', 'images', 'image_embeds')
    ...
    def train(self, num_epochs, stop_at_loss = None, display_graph = False):
...
class MeshTransformerTrainer(Module):
    ...
    def __init__(
        ...
        checkpoint_every_epoch: Type[int] | None = None,
        checkpoint_folder = './checkpoints',
        data_kwargs: Tuple[str, ...] = ('vertices', 'faces', 'face_edges', 'text_embeds', 'image_embeds'),
        warmup_steps = 1000,
        use_wandb_tracking = False
    ):
        super().__init__()
